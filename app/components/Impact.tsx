...
export default function Impact({ scrollProgress }: ImpactProps) {
  ...
  return (
    <>
      ...
      >
      <h2 className="text-4xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-black mb-12 sm:mb-16">
        Impact
      </h2>
              ...
              {jobs.map((job, jobIndex) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-black via-black/90 to-black/70 bg-clip-text text-transparent">
                        {job.company}
                      </h3>
                      <div className="flex flex-wrap items-center gap-3 sm:gap-4">
                        <span className="text-base sm:text-lg md:text-xl text-black/90 font-semibold px-3 py-1 rounded-full bg-black/5 backdrop-blur-sm border border-black/20">
                          {job.role}
                        </span>
                        <span className="text-sm sm:text-base md:text-lg text-black/60 font-light italic">
                          {job.period}
                        </span>
                      </div>
                    </div>
                      ...
                      {job.achievements.map((text, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <p className="text-base sm:text-lg md:text-xl font-normal text-black/85 leading-relaxed tracking-[-0.02rem]">
                              {text}
                            </p>
                          </li>
                        );
          ...
          {contactLinks.map((link) => {
            ...
            return (
              <a
                ...
                className="group flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-14 md:h-14 bg-white/60 backdrop-blur-md border border-black/20 rounded-xl transition-all duration-500 hover:border-black/40 hover:shadow-2xl hover:shadow-black/10 hover:scale-110 text-black hover:text-black/90"
